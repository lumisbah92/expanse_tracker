    ...
    <div className="sticky top-0 bg-white z-10 w-full h-[72px] border-b border-gray-200 flex items-center justify-between px-2 lg:px-5">
      <div className="h-20 flex items-center">
        <div className="flex md:hidden">
          <div className="text-[16px] font-semibold leading-[31.47px] tracking-wide text-[#243642]">
      ...
      <div className="relative flex items-center gap-3">
        <div className="flex md:hidden gap-3">
          <button onClick={() => (window.location.href = '/')} className="text-sm text-gray-600 hover:text-gray-800">Dashboard</button>
          <button onClick={() => (window.location.href = '/add-transaction')} className="text-sm text-gray-600 hover:text-gray-800">Add Transaction</button>
        </div>
